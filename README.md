...
O projeto é um calendario dos jogos da copa do mundo desenvolvido durante evento da rocketseat
...
```bash
git clone https://github.com/MatheusRamalho/boarding-pass
```
